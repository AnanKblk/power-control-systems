      ...
      <div className="max-w-7xl mx-auto" ref={ref}>
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            A comprehensive range of industrial equipment and solutions,
            carefully sourced and supplied to meet the most demanding project
            requirements.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.5, delay: 0.1 + products.length * 0.07 }}
          ...
          >
            <div>
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                Our team sources specialized equipment for unique project
